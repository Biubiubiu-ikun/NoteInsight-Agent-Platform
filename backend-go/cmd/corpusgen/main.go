...
func main() {
	var (
		...
		evalCasesPerNote = flag.Int("eval-cases-per-note", 0, "override ground-truth cases per note, max 8")
		projectID        = flag.Int64("project-id", 1, "project identifier assigned to generated notes")
